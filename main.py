...
if os.path.isfile(NAME_BACKBONE+".h5") and not TRAIN:
    ...
    model.fit(images, labels, validation_data=(images_validation, labels_validation), epochs=100, batch_size=64, callbacks=[mcp_save_val_loss_min, mcp_save_loss_min])
